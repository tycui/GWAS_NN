...
train_errors, test_errors = training(SSBNN, x_train, phenotype_y, x_test, phenotype_y_test, learning_rate, batch_size, num_epoch)
print('BNN model :')
splited_x_test = splite_data(x_test, gene_size)
PTVE_test(SSBNN, splited_x_test, phenotype_y_test)
...
np.savetxt(cwd+'/InteractionScore/'+name+'.csv', Shapely_BNN, delimiter=",")
